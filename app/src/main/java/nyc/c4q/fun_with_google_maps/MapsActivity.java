package nyc.c4q.fun_with_google_maps;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
                    ...
                    .addOnSuccessListener(this, new OnSuccessListener <Location>() {
                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                mMap.addMarker(new MarkerOptions().position(new LatLng(lat, lng)).title("Market in NYC ").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_round)));
                            }
                        }
                    });
        }
        ...
        try {
            address= geocoder.getFromLocationName("3105 Astoria Blvd S, Astoria, NY 11102", 5);
            if (address != null) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                double lag= latLng.latitude;
                mMap.addMarker(new MarkerOptions().position(new LatLng(lag, lng)).title("currentClick"));
            }
        });
        // Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(-34, 151);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Sydney"));
//        CameraPosition nyc = CameraPosition.builder()
...
//                .build();
        ...
        mMap.addMarker(new MarkerOptions().position(nyc).title("NYC"));
